...
interface BaseEmailProps {
  ...
  --------------------------------------------------- */
  interface AdminCreatedUserProps {
    recipientName: string;
    email: string;
    password: string;
    resetToken: string;
  ...
  const adminCreatedUserTemplate = ({
    recipientName,
    email,
    password,
    resetToken,
  ...
  export const emailTemplates = {
    ...
    adminCreatedUser: (props: AdminCreatedUserProps) =>
      adminCreatedUserTemplate(props),
  };
