...
private isOrderLocked(order: Order): boolean {
  ...
  private isValidStatusTransition(from: OrderStatus, to: OrderStatus): boolean {
    ...
    const validTransitions: Record<OrderStatus, OrderStatus[]> = {
      ...
      [OrderStatus.DEPOSIT_PENDING]: [OrderStatus.HALF_DEPOSIT_PAID, OrderStatus.DEPOSIT_PAID, OrderStatus.CANCELLED],
      [OrderStatus.HALF_DEPOSIT_PAID]: [OrderStatus.DEPOSIT_PAID, OrderStatus.BALANCE_PAID, OrderStatus.CANCELLED],
