...
let OrderService = class OrderService {
    ...
    isValidStatusTransition(from, to) {
        ...
        const validTransitions = {
            ...
            [client_1.OrderStatus.DEPOSIT_PENDING]: [client_1.OrderStatus.HALF_DEPOSIT_PAID, client_1.OrderStatus.DEPOSIT_PAID, client_1.OrderStatus.CANCELLED],
            [client_1.OrderStatus.HALF_DEPOSIT_PAID]: [client_1.OrderStatus.DEPOSIT_PAID, client_1.OrderStatus.BALANCE_PAID, client_1.OrderStatus.CANCELLED],
